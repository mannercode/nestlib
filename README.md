...
| --------------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| [`@mannercode/nest-common`](packages/common/)             | 유틸리티, 타입, 로깅, Mongoose, Redis, S3, JWT 인증 | [![npm](https://img.shields.io/npm/v/@mannercode/nest-common)](https://www.npmjs.com/package/@mannercode/nest-common)             |
| [`@mannercode/nest-microservice`](packages/microservice/) | NATS RPC (ClientProxy), Temporal.io 클라이언트/워커 | [![npm](https://img.shields.io/npm/v/@mannercode/nest-microservice)](https://www.npmjs.com/package/@mannercode/nest-microservice) |
| [`@mannercode/nest-testing`](packages/testing/)           | 테스트 유틸 (HttpTestClient, RpcTestClient 등)      | [![npm](https://img.shields.io/npm/v/@mannercode/nest-testing)](https://www.npmjs.com/package/@mannercode/nest-testing)           |
...
```bash
# common만 사용
npm install @mannercode/nest-common

# 마이크로서비스 아키텍처 사용
npm install @mannercode/nest-common @mannercode/nest-microservice

# 테스트 유틸은 devDependencies로
npm install -D @mannercode/nest-testing
```
...
```bash
git clone https://github.com/mannercode/nest-libs.git
cd nest-libs
npm install
```
...
# 특정 패키지만 빌드
npx turbo run build --filter=@mannercode/nest-common
